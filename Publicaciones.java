...
public class Publicaciones extends JPanel {
    ...
    public Publicaciones() {
        ...
        // Panel para escribir nuevo post
    ...
    private void cargarPublicaciones() {
        ...
        try (Connection con = ConexionDB.getConexion();
            ...
            while (rs.next()) {
                ...
                panelPosts.add(crearTarjetaPost(autor, texto, fecha));
            }
    ...
    private void publicar(String texto) {
        // Requiere un usuarioId real de sesión; aquí se deja como ejemplo con UUID fijo de prueba
        // En integración real, recibir el id del usuario logueado
        String sql = "INSERT INTO publicaciones (id, usuario_id, contenido, tipo) " +
                     "SELECT ?, id, ?, 'post' FROM usuarios LIMIT 1";
        try (Connection con = ConexionDB.getConexion();
    ...
    public static void main(String[] args) {
        JFrame f = new JFrame("Publicaciones");
        f.setSize(1000, 700);
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        f.add(new Publicaciones());
        f.setVisible(true);
    }
}