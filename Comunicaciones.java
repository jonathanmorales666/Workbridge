...
public class Comunicaciones extends JPanel {
    ...
    private void cargarMensajes() {
        ...
        String sql = "SELECT titulo, mensaje, creado_en FROM notificaciones WHERE tipo = 'mensaje' ORDER BY creado_en DESC LIMIT 50";
    ...
    public static void main(String[] args) {
        JFrame f = new JFrame("Comunicaciones");
        f.setSize(900, 600);
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        f.add(new Comunicaciones());
        f.setVisible(true);
    }
}